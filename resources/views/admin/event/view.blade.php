            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="content">
                            <div class="toolbar">
                                <a href="{{url('admin/event/create')}}" rel="tooltip" title="Добавить новое событие"
                            ...
                            <table id="bootstrap-table" class="table">
                                ...
                                <th data-field="venue" class="text-center">Место</th>
                                <th data-field="price">Цена</th>
                                <th data-field="capacity">Вместимость</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-icons">
                                                        <a rel="tooltip" title="Редактировать"
                                                           class="btn btn-simple btn-warning btn-icon table-action edit"
                                                           href="{{url('admin/event/'.$event->id.'/edit')}}">
                                                            <i class="ti-pencil-alt"></i>
                                                        </a>
                                                        <button rel="tooltip" title="Удалять"
                                                        ...
                                                        <div class="collapse">
                                                            ...
                                                            <button type="submit" class="btn btn-danger btn-ok">Удалять</button>
                                                            {!! Form::close() !!}
                                                        </div>
