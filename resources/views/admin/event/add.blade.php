        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Добавить событие в меню</h4>
                        </div>
                        <div class="content">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Название события<star>*</star></label>
                                        <input type="text" name="name" class="form-control border-input"
                                               placeholder="мгту" value="{{ old('name') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Вместимость<star>*</star></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Место<star>*</star></label>
                                        <input type="text" name="venue" class="form-control border-input"
                                               placeholder="Ex: Место" value="{{ old('venue') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-info btn-fill btn-wd">Добавить событие
                                </button>
                            </div>
