            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="content">
                            <div class="toolbar">
                                <a href="{{url('admin/slider/create')}}" rel="tooltip" title="Добавить новый"
                            ...
                            <table id="bootstrap-table" class="table">
                                ...
                                <th data-field="small_title" data-sortable="true">Небольшое название</th>
                                <th data-field="big_title" data-sortable="true">Громкое название</th>
