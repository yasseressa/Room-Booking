                    ...
                    <div class="card">
                        ...
                        <div class="content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type" class="form-control">
                                            <option value="Закуска"
                                                    @if ($food->type == 'Закуска') selected="selected" @endif>Закуска
                                            </option>
                                            <option value="Суп"
                                                    @if ($food->type == 'Суп') selected="selected" @endif>Суп
                                            </option>
                                            <option value="Салат"
                                                    @if ($food->type == 'Салат') selected="selected" @endif>Салат
                                            </option>
                                            <option value="основное блюдо"
                                                    @if ($food->type == 'основное блюдо') selected="selected" @endif>основное блюдо
                                            </option>
                                            <option value="Десерт"
                                                    @if ($food->type == 'Десерт') selected="selected" @endif>Десерт
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-info btn-fill btn-wd">Обновить меню блюд</button>
                            </div>
