                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="gender" id="gender" class="form-control">
                                            ...
                                            <option value="М" @if (Input::old('gender') == 'М') selected="selected" @endif>М
                                            </option>
                                            <option value="Ж" @if (Input::old('gender') == 'Ж') selected="selected" @endif>Ж
                                            </option>
                                            <option value="другие" @if (Input::old('gender') == 'другие') selected="selected" @endif>другие
                                            </option>
                                        </select>
                                    </div>
                                </div>
