            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="content">
                            <div class="toolbar">
                                <a href="{{url('admin/room_type/'.$room_type->id.'/room/create')}}" rel="tooltip" title="Добавить новую комнату"
                            ...
                            <table id="bootstrap-table" class="table">
                                ...
                                <th data-field="id" class="text-center">Номер комнаты</th>
                                <th data-field="availability" class="text-center">Доступность</th>
                                        ...
                                        @foreach($room_type->rooms as $index => $room)
                                            <tr>
                                                ...
                                                <td>@if($room->available == 1)
                                                        <button class="btn btn-danger btn-xs btn-fill">Доступный</button>
                                                    @else
                                                        <button class="btn btn-default btn-xs btn-fill">Забронированы
                                                        </button>
                                                    @endif</td>
                                                <td>
                                                    @if($room->status == 1)
