        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Добавить тип комнаты</h4>
                        </div>
                        <div class="content">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Название типа комнаты<star>*</star></label>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-info btn-fill btn-wd">AДобавить тип комнаты
                                </button>
                            </div>
