                    ...
                    <div class="card">
                        ...
                        <div class="content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Стоимость За День<star>*</star></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Скидка: <input class="form-control border-input" type="text" id="discount" disabled></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Максимальное количество взрослых<star>*</star></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Максимальное количество детей<star>*</star></label>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    @empty
                                        <p>К сожалению, удобства недоступны</p>
                                    @endforelse
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Обслуживание комнат</label>
                                        <select name="room_service" id="room_service" class="form-control">
                                            <option value="1"
                                                    @if ($room_type->room_service == '1') selected="selected" @endif>Доступный
                                            </option>
                                            <option value="0"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            <option value="1"
                                                    @if ($room_type->status == '1') selected="selected" @endif>Активный
                                            </option>
                                            <option value="0"
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-info btn-fill btn-wd">Обновить тип комнаты</button>
                            </div>
