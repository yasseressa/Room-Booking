            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="content">
                            <div class="toolbar">
                                <a href="{{url('admin/room_type/create')}}" rel="tooltip" title="Добавить новый"
                            ...
                            <table id="bootstrap-table" class="table">
                                ...
                                <th data-field="cost_per_day">Стоимость За День</th>
                                <th data-field="discount_percentage">Скидка</th>
                                <th data-field="max_adult">Максимальный взрослый</th>
                                <th data-field="max_child">Максимальный ребенок</th>
