            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="content">
                            <div class="toolbar">
                                <a href="{{url('admin/room_type/'.$room_type->id.'/image/create')}}" rel="tooltip" title="Добавить новый"
                            ...
                            <table id="bootstrap-table" class="table">
                                ...
                                <th data-field="id" class="text-center">Изображение</th>
                                <th data-field="caption" data-sortable="true">Подпись</th>
                                <th data-field="is_primary" data-sortable="true">Is Первичный</th>
                                        ...
                                        @foreach($room_type->images as $index => $image)
                                            <tr>
                                                ...
                                                <td>@if($image->is_primary == 1)
                                                        <button class="btn btn-danger btn-xs btn-fill">да</button>
                                                    @else
                                                        <button class="btn btn-default btn-xs btn-fill">нет
                                                        </button>
                                                    @endif</td>
                                                <td>
                                                    @if($image->status == 1)
