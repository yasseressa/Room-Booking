                    ...
                    <div class="card">
                        <div class="content">
                            <table id="bootstrap-table" class="table">
                                ...
                                <th data-field="user" class="text-center">Пользователь</th>
                                <th data-field="room_type" class="text-center">Тип комнаты</th>
                                <th data-field="room_number" data-visible="false" class="text-center">Номер комнаты</th>
                                <th data-field="review">Обзор</th>
                                <th data-field="rating">Рейтинг</th>
                                <th data-field="approval_status" data-sortable="true">Статус</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($review->approval_status == "pending")
                                                        <button class="btn btn-default btn-xs btn-fill">очереди</button>
                                                    @elseif($review->approval_status == "approved")
                                                        <button class="btn btn-success btn-xs btn-fill">Одобренный
                                                        </button>
                                                    @else
                                                        <button class="btn btn-danger btn-xs btn-fill">Отклоненный
                                                        </button>
                                                    @endif
                                                </td>
                                                <td>
