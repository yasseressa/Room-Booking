...
class Booking
{
    ...
    {
        return 'Извините, на указанные даты свободных номеров нет. Пожалуйста, попробуйте забронировать на другую дату.';
    }
    ...
    protected function rooms_exist()
    {
        ...
        $this->message = "К сожалению, свободных номеров данного типа нет.";
        return false;
    }
