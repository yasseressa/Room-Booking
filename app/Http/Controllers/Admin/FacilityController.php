...
class FacilityController extends AdminController
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('flash_message', 'Объект был успешно добавлен');
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('flash_title', 'Success');
        Session::flash('flash_message', 'Объект был успешно обновлен');
        return redirect('admin/facility');
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash('flash_title', 'Success');
        Session::flash('flash_message', 'Объект был успешно удалено');
        return redirect('admin/facility');
