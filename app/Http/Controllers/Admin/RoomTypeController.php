...
class RoomTypeController extends AdminController
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('flash_message', 'Тип комната была успешно добавлена');
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('flash_title', 'Success');
        Session::flash('flash_message', 'Тип комната была успешно обновлена');
        return redirect('admin/room_type');
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash('flash_title', 'Success');
        Session::flash('flash_message', 'Тип комната была успешно удалена');
        return redirect('admin/room_type');
