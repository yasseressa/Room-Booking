...
class FoodController extends AdminController
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'type' => 'required|in:Закуска,Суп,Салат,основное блюдо,Десерт',
        ...
        Session::flash('flash_message', 'еда была успешно добавлена');
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'type' => 'required|in:Закуска,Суп,Салат,основное блюдо,Dessert',
            'price' => 'required|numeric|min:0',
            'description' => 'max:100',
            'status' => 'required|boolean'
        ];
        ...
        Session::flash('flash_title', 'Success');
        Session::flash('flash_message', 'еда была успешно обновлена');
        return redirect('admin/food');
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash('flash_title', 'Success');
        Session::flash('flash_message', 'еда была успешно удалена');
        return redirect('admin/food');
